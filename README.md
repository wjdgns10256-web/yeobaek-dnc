...
Next.js(App Router) + Tailwind CSS로 제작한 기업 홈페이지입니다. 홈은 회사소개·사업분야·
시공사례를 간단히 보여주고, 사업분야/시공사례 카테고리는 각각 별도 페이지로 상세 내용을
제공하는 구조입니다.
...
| 경로 | 내용 |
| --- | --- |
| `/` | 히어로, 회사소개(요약), 발주처 마퀴, 사업분야(카드→링크), 시공사례(카테고리 타일→링크), 문의 |
