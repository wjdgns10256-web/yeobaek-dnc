              ...
              <Reveal key={cat.key} delay={i * 100}>
                ...
                >
                  ...
                  <div className="absolute inset-x-0 bottom-0 flex items-end justify-between p-6">
                    ...
                    <span className="flex h-10 w-10 flex-none items-center justify-center rounded-full bg-white/10 text-white transition-all duration-300 group-hover:scale-110 group-hover:bg-accent-700">
