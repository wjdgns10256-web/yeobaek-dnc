...
export default function Services() {
  return (
    <section id="services" className="bg-ink-50 py-20 sm:py-28">
      <div className="section-pad mx-auto max-w-content">
        <div className="max-w-2xl">
          ...
          <h2 className="mt-3 text-3xl font-bold tracking-tight text-ink sm:text-4xl">사업분야</h2>
        ...
        <div className="mt-14 grid grid-cols-1 gap-8 md:grid-cols-3">
          {services.map((service) => (
            <div
              key={service.id}
              className="overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-ink-100 transition-shadow hover:shadow-lg"
            >
